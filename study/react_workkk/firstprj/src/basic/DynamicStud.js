...
class GenStud extends Stud{
    constructor(name, kor, eng, mat){
        super('일반',name, kor, eng, mat) //부모생성자 --> 자식클래스에서 생성자를 명시할 경우 부모생성자 필수 지정해야 한다.
    }
    calc(){  
...
class ArtStud extends Stud{
    constructor(name, kor, eng, mat, art){
        super('예능',name,kor, eng, mat, art) //부모생성자 --> 자식클래스에서 생성자를 명시할 경우 부모생성자 필수 지정해야 한다.
